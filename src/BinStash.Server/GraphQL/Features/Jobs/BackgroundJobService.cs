        ...
        else if (job.JobType == BackgroundJobTypes.ChunkStoreGc)
        {
            ...
            return new BackgroundJobGql
            {
                ...
                GcProgress = new GcJobProgressGql
                {
                    ...
                    ResolvedFileDefinitions = progress?.ResolvedFileDefinitions ?? 0,
                    ProcessedFileDefinitionGroups = progress?.ProcessedFileDefinitionGroups ?? 0,
                    TotalFileDefinitionGroups = progress?.TotalFileDefinitionGroups ?? 0,
