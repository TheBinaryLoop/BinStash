...
namespace BinStash.Infrastructure.Data.Migrations
{
    ...
    [Migration("20251219181841_AddFirstMiddleAndLastNameToUserTable")]
    partial class AddFirstMiddleAndLastNameToUserTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BinStash.Core.Entities.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BinStash.Core.Entities.UserRefreshToken", b =>
                {
                    b.HasOne("BinStash.Core.Entities.User", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("BinStash.Core.Entities.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
